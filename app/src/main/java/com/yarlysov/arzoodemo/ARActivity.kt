...
class ARActivity : AppCompatActivity(R.layout.activity_aractivity) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        Log.d("Working_Log", "Alive!")
        super.onCreate(savedInstanceState)
        /*
        for (item in animals.indices){
           if (mess == animals[item].getId()){
               anim = animals[item]
               break
           }
        }*/
            ...
            AnchorNode(sceneView.engine, anchor)
                .apply {
                    ...
                    lifecycleScope.launch {
                        isLoading = true
                        sceneView.modelLoader.loadModelInstance("https://sceneview.github.io/assets/models/DamagedHelmet.glb")?.let { modelInstance ->
                            addChildNode(
                                ModelNode(
